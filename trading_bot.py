...
class TradingBot:
    # Later: TradingBot """Has methods to determine behavior as a function of inputs, and these behaviors occur through execution of public methods.
    ...
    \nbuy_setting:\n\n1: buy\n\n2: buyRandom\n\n3: buyOptimal_1\n\n4: buyOptimal_2\n\n5: buyOptimal_3\n\nsell_setting\n\n1: sell\n\n2: sellRandom\n\n3: sellOptimal_1\n\n4: sellOptimal_2\n\n5: sellOptimal_3"""
    def __init__(self, initial_balance: float =0, buy_setting: int =1, sell_setting: int =1) -> None:  # TODO Bot shouldn't have balance, or operating cost, Firm should though
    ...
    def settings_string(buy_setting, sell_setting) -> str:
        return f"{['buy', 'buyRandom', 'buyOptimal_1', 'buyOptimal_2', 'buyOptimal_3'][buy_setting - 1]}, {['sell', 'sellRandom', 'sellOptimal_1', 'sellOptimal_2', 'sellOptimal_3'][sell_setting - 1]}"

    def __str__(self) -> str:
        return f"TradingBot: {self.settings_string(self.buy_setting, self.sell_setting)}"

    def string_to_trading_bot(self, input_str: str, display_bool: bool =False) -> None:  # O(N) = O(len(input_str.split('\n')))
    ...
    def total_times(self) -> tuple[float, float]:  # buy time, sell time  # O(1)
